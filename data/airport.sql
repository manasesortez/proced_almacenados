...
/**Delimiter de FLight*/
DELIMITER //
CREATE PROCEDURE setFlight(IN flight_id INT, IN flight_datetime_depart DATETIME,IN flight_datetime_arrival DATETIME, IN flight_weather_report VARCHAR(100), IN flight_country_depart_id INT, IN flight_city_depart_id INT , IN flight_city_arrival_id INT ,IN flight_country_arrival_id INT, IN status_id INT,IN aircraft_id INT, IN airline_id INT,IN user_id INT)
BEGIN
    INSERT INTO flight VALUES (flight_id, flight_datetime_depart, flight_datetime_arrival, flight_weather_report, flight_country_depart_id, flight_city_depart_id, flight_city_arrival_id, flight_country_arrival_id, status_id, aircraft_id, airline_id, user_id);
end //
DELIMITER ;
